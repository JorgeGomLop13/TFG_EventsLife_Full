...
export const GLOBAL_MESSAGE_DEFAULT_DURATION = 5000;
export const GLOBAL_MESSAGE_DEFAULT_HORIZONTAL_POSITION = 'right';
export const GLOBAL_MESSAGE_DEFAULT_VERTICAL_POSITION = 'top';
